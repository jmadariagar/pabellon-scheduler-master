...
urlpatterns = [
    ...
    path('update-schedule-extended', updateScheduleExtended, name='update-schedule-extended'),
    ...
    path('programacion/<int:id_result>/extendidos', ExtendidosView.as_view(), name='programacion-extendidos'),
